...
|---|---|---|
| `ts/` | @voxgig-sdk/multifon-client-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/multifon-client-sdk \
      --repository voxgig-sdk/multifon-client-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/multifon-client-sdk` shows it, and
`npm trust revoke @voxgig-sdk/multifon-client-sdk --id=<id>` removes it.
