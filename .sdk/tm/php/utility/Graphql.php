...
// MultifonClient SDK utility: graphql
//
...
class MultifonClientGraphql
{
    ...
    // equivalent.
    public static function body(MultifonClientContext $ctx): mixed
    {
    ...
    public static function errors(MultifonClientContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
