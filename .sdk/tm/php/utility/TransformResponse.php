...
// MultifonClient SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MultifonClientTransformResponse
{
    public static function call(MultifonClientContext $ctx): mixed
    {
        ...
        $transform = MultifonClientHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
