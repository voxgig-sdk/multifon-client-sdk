...
// MultifonClient SDK utility: fetcher

class MultifonClientFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MultifonClientSDK/1.0)';
    ...
    public static function call(MultifonClientContext $ctx, string $fullurl, array $fetchdef): array
    {
