...
// MultifonClient SDK pipeline test
//
...
{
    private static function utility(): MultifonClientUtility
    {
        return new MultifonClientUtility();
    }
    ...
    private static function ctx(array $over = []): MultifonClientContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MultifonClientContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MultifonClientOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MultifonClientError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MultifonClientOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MultifonClientMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MultifonClientOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MultifonClientMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MultifonClientOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MultifonClientMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MultifonClientSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MultifonClientMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = MultifonClientMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MultifonClientSpec([]),
            'response' => null,
            'result' => new MultifonClientResult([]),
        ]);
        [, $err] = MultifonClientMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MultifonClientSpec(['step' => 's']),
            'response' => new MultifonClientResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MultifonClientResult([]),
        ]);
        [, $err] = MultifonClientMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MultifonClientSpec(['step' => 's']),
            'response' => new MultifonClientResponse(self::resp(200, ['v' => 1])),
            'result' => new MultifonClientResult([]),
        ]);
        [, $err] = MultifonClientMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MultifonClientSpec(['step' => 's']),
            'response' => new MultifonClientResponse(self::resp(200, ['v' => 2])),
            'result' => new MultifonClientResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MultifonClientMakeResponse::call($ctx);
    ...
    {
        $preset = new MultifonClientResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MultifonClientSpec([]),
            'response' => new MultifonClientResponse([]),
            'result' => new MultifonClientResult([]),
        ...
        [$got, $err] = MultifonClientMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MultifonClientResult([])]);
        [, $err] = MultifonClientMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MultifonClientSpec([]), 'result' => null]);
        [, $err] = MultifonClientMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MultifonClientSpec(['step' => 's']),
            'result' => new MultifonClientResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MultifonClientOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MultifonClientMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MultifonClientSpec(['step' => 's']),
            'result' => new MultifonClientResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MultifonClientOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MultifonClientMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MultifonClientResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MultifonClientSpec([]),
            'result' => new MultifonClientResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MultifonClientMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MultifonClientMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MultifonClientError('boom', 'boom');
        $utility->fetcher = function (MultifonClientContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MultifonClientSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MultifonClientMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MultifonClientContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MultifonClientMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MultifonClientResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MultifonClientMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MultifonClientContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MultifonClientSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MultifonClientMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MultifonClientResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MultifonClientSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MultifonClientMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MultifonClientMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MultifonClientMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MultifonClientResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MultifonClientDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MultifonClientResult(['ok' => false])]);
        $this->expectException(MultifonClientError::class);
        MultifonClientDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MultifonClientResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MultifonClientMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MultifonClientMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MultifonClientBaseFeature();
        $b = new MultifonClientBaseFeature();
        MultifonClientFeatureAdd::call($ctx, $a);
        MultifonClientFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MultifonClientBaseFeature
    {
        $f = new MultifonClientBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MultifonClientFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MultifonClientContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MultifonClientSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MultifonClientPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MultifonClientPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MultifonClientResponse(['headers' => null]),
            'result' => new MultifonClientResult([]),
        ]);
        MultifonClientResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MultifonClientResultBody::call($ctx);
