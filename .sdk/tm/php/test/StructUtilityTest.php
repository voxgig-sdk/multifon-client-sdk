...
// MultifonClient SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MultifonClientOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MultifonClientOmni::structfix($now, Struct::undef()))
                        !== json_encode(MultifonClientOmni::structfix($val, Struct::undef()))) {
