...
// MultifonClient SDK utility type

class MultifonClientUtility
{
    ...
    public static function copy(MultifonClientUtility $src): MultifonClientUtility
    {
        $u = new MultifonClientUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
