...
// MultifonClient SDK audit feature
...
class MultifonClientAuditFeature extends MultifonClientBaseFeature
{
    ...
    private function _emit(MultifonClientContext $ctx, string $outcome): void
    {
