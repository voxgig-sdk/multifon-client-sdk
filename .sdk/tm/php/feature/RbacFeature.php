...
// MultifonClient SDK rbac feature
...
class MultifonClientRbacFeature extends MultifonClientBaseFeature
{
    ...
    private function _required(MultifonClientContext $ctx): ?string
    {
    ...
    private function _reject(MultifonClientContext $ctx, string $required): void
    {
    ...
    private function _track(MultifonClientContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
