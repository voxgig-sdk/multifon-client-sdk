...
// MultifonClient SDK clienttrack feature
...
class MultifonClientClienttrackFeature extends MultifonClientBaseFeature
{
    ...
    public function PostConstruct(MultifonClientContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MultifonClient-SDK';
