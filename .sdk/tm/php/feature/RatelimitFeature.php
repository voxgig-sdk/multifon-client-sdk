...
// MultifonClient SDK ratelimit feature
...
class MultifonClientRatelimitFeature extends MultifonClientBaseFeature
{
    ...
    private function _acquire(MultifonClientContext $ctx): void
    {
    ...
    private function _track(MultifonClientContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
