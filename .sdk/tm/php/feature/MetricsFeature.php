...
// MultifonClient SDK metrics feature
...
class MultifonClientMetricsFeature extends MultifonClientBaseFeature
{
    ...
    private function _record(MultifonClientContext $ctx, bool $ok): void
    {
