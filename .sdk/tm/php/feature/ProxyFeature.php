...
// MultifonClient SDK proxy feature
...
class MultifonClientProxyFeature extends MultifonClientBaseFeature
{
    ...
    public function init(MultifonClientContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MultifonClientContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
