...
// MultifonClient SDK netsim feature
...
class MultifonClientNetsimFeature extends MultifonClientBaseFeature
{
    ...
    private function _simulate(MultifonClientContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MultifonClientContext $ctx, array $applied): void
    {
        $client = $this->client;
