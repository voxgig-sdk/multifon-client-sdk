...
// MultifonClient SDK telemetry feature
...
class MultifonClientTelemetryFeature extends MultifonClientBaseFeature
{
    ...
    private function _close(MultifonClientContext $ctx, bool $ok): void
    {
