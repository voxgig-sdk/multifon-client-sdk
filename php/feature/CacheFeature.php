...
// MultifonClient SDK cache feature
...
class MultifonClientCacheFeature extends MultifonClientBaseFeature
{
    ...
    private function _through(MultifonClientContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
