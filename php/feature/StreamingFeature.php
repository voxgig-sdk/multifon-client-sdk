...
// MultifonClient SDK streaming feature
...
class MultifonClientStreamingFeature extends MultifonClientBaseFeature
{
    ...
    private function _iterate(MultifonClientResult $result): \Generator
    {
    ...
    private function _streamable(MultifonClientContext $ctx): bool
    {
