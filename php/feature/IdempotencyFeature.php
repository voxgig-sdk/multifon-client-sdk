...
// MultifonClient SDK idempotency feature
...
class MultifonClientIdempotencyFeature extends MultifonClientBaseFeature
{
    ...
    private function _mutating(MultifonClientContext $ctx): bool
    {
