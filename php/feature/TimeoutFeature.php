...
// MultifonClient SDK timeout feature
...
class MultifonClientTimeoutFeature extends MultifonClientBaseFeature
{
    ...
    private function _with_timeout(MultifonClientContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MultifonClientContext $_ctx, float $ms): void
    {
        $client = $this->client;
