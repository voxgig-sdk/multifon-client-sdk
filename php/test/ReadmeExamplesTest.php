...
// MultifonClient SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MultifonClientSDK::test)
...
{
    private const SDK_CLASS = 'MultifonClientSDK';
    ...
    private const SDK_BASE = 'multifonclient_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../multifonclient_sdk.php';
