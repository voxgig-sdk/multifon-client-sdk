...
class AccountManagementEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MULTIFONCLIENT_TEST_ACCOUNT_MANAGEMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function account_management_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MULTIFONCLIENT_TEST_ACCOUNT_MANAGEMENT_ENTID");
