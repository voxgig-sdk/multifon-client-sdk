...
type Args struct {
	Entity string         `json:"entity" jsonschema:"account_management | api"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MultifonClientSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "multifon-client_list",
		Description: "List records from MultifonClient. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "multifon-client_load",
		Description: "Load a single record from MultifonClient. " +
...
func runOp(client *sdk.MultifonClientSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MultifonClientSDK, name string) (sdk.MultifonClientEntity, error) {
	switch strings.ToLower(name) {
	case "account_management":
		return client.AccountManagement(nil), nil
	case "api":
