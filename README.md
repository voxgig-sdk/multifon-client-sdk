...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/multifon-client` | `npm install @voxgig-sdk/multifon-client` |
| Python | `voxgig-sdk-multifon-client` | `pip install voxgig-sdk-multifon-client` |
| PHP | `voxgig-sdk/multifon-client` | `composer require voxgig-sdk/multifon-client` |
| Golang | `github.com/voxgig-sdk/multifon-client-sdk/go` | `go get github.com/voxgig-sdk/multifon-client-sdk/go` |
| Ruby | `voxgig-sdk-multifon-client` | `gem install voxgig-sdk-multifon-client` |
| Lua | `voxgig-sdk-multifon-client` | `luarocks install voxgig-sdk-multifon-client` |
