...
describe("AccountManagementDirect", function()
  it("should direct-load-account_management", function()
    local setup = account_management_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-account_management", setup.live and "live" or "unit")
...
function account_management_direct_setup(mockres)
