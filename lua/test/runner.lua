...
function runner.env_override(m)
  local live = runner.getenv("MULTIFON_CLIENT_TEST_LIVE")
  local override = runner.getenv("MULTIFON_CLIENT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MULTIFON_CLIENT_TEST_EXPLAIN")
