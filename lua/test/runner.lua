...
function runner.env_override(m)
  local live = runner.getenv("MULTIFONCLIENT_TEST_LIVE")
  local override = runner.getenv("MULTIFONCLIENT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MULTIFONCLIENT_TEST_EXPLAIN")
