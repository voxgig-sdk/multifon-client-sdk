...
local AccountManagementEntity = {}
AccountManagementEntity.__index = AccountManagementEntity


function AccountManagementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountManagementEntity)
  self._name = "account_management"
  self._client = client
...
function AccountManagementEntity:get_name()
  return self._name
end


function AccountManagementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AccountManagementEntity.new(self._client, opts)
end
...
function AccountManagementEntity:mark_deleted()
  self._deleted = true
end


function AccountManagementEntity:deleted()
  return true == self._deleted
end


function AccountManagementEntity:data_set(args)
  if args ~= nil then
...
function AccountManagementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountManagementEntity:match_set(args)
  if args ~= nil then
...
function AccountManagementEntity:match_get()
...
function AccountManagementEntity:stream(action, args, callopts)
...
---@param reqmatch AccountManagementLoadMatch
---@param ctrl? table
---@return AccountManagement
---@return string? err
function AccountManagementEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AccountManagementEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AccountManagementEntity
