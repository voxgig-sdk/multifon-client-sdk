...
describe('exists', async () => {
  ...
  //
  // MultifonClientSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof MultifonClientSDK, true,
      'MultifonClientSDK.test() must return a client synchronously')
  })
