...
function envOverride(m) {
    if ('TRUE' === process.env.MULTIFON_CLIENT_TEST_LIVE ||
        'TRUE' === process.env.MULTIFON_CLIENT_TEST_OVERRIDE) {
    ...
    m.MULTIFON_CLIENT_TEST_EXPLAIN = process.env.MULTIFON_CLIENT_TEST_EXPLAIN || m.MULTIFON_CLIENT_TEST_EXPLAIN;
    return m;
}
