...
#      offline in seeded test mode (MultifonClientSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MultifonClient_sdk.rb")
  SDK_CLASS = "MultifonClientSDK"
