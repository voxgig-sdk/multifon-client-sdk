# MultifonClient Python SDK



The Python SDK for the MultifonClient API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.AccountManagement()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/multifon-client-sdk/releases)) or
...
```
py/
├── multifonclient_sdk.py         -- Main SDK module
