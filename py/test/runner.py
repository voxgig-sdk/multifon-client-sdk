...
class MultifonClientTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MultifonClientTestRunner.getenv("MULTIFONCLIENT_TEST_LIVE")
        override = MultifonClientTestRunner.getenv("MULTIFONCLIENT_TEST_OVERRIDE")
        ...
        explain = MultifonClientTestRunner.getenv("MULTIFONCLIENT_TEST_EXPLAIN")
