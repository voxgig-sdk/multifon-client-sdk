# MultifonClient SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MultifonClientSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MultifonClientSDK(...) and MultifonClientSDK.test(...) become
#      MultifonClientSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "multifonclient_sdk"
_SDK_CLASS = "MultifonClientSDK"
