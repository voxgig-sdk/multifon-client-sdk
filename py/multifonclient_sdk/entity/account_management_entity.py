...
from multifonclient_sdk.multifonclient_types import (
    AccountManagement,
...
class AccountManagementEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountManagementEntity(self._client, opts)
    ...
    def data_get(self) -> AccountManagement:
    ...
    def match_get(self) -> AccountManagement:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AccountManagement:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AccountManagement().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
