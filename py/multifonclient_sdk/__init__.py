...
from multifonclient_sdk.utility import register

# Load features
from multifonclient_sdk.feature.base_feature import MultifonClientBaseFeature
from multifonclient_sdk.features import _has_feature, _make_feature
...
class MultifonClientSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MultifonClientUtility()
        self._utility = utility

        from multifonclient_sdk.config import shared_config
    ...
    def get_utility(self):
        return MultifonClientUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MultifonClientSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AccountManagement(self, data=None) -> "AccountManagementEntity":
        ...
        from multifonclient_sdk.entity.account_management_entity import AccountManagementEntity
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from multifonclient_sdk.entity.api_entity import ApiEntity
