...
from multifonclient_sdk.core.control import MultifonClientControl
...
from multifonclient_sdk.core.helpers import get_ctx_prop, to_map
...
class MultifonClientContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MultifonClientControl()
        ...
        if isinstance(sp, MultifonClientSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MultifonClientResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MultifonClientResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MultifonClientOperation({})
    ...
    def make_error(self, code, msg):
        return MultifonClientError(code, msg, self)
