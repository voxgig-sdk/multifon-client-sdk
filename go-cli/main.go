// Command MultifonClient-cli is a CLI + REPL for the MultifonClient SDK,
...
const prompt = "multifon-client"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "account_management api"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MULTIFON_CLIENT_APIKEY (api key), MULTIFON_CLIENT_BASE (base url override)")
