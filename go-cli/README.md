...
AQL-driven CLI and REPL for the MultifonClient SDK. Positional arguments are
...
```sh
go build -o multifon-client-cli ./...
```
...
./multifon-client-cli list account_management
./multifon-client-cli load 1 account_management
./multifon-client-cli load '{id:1}' account_management
