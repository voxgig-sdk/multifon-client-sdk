...
func registerSDKWords(r *eng.Registry, client *sdk.MultifonClientSDK) {
...
func runOp(client *sdk.MultifonClientSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
