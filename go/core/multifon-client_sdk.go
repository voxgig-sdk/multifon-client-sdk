...
func (sdk *MultifonClientSDK) OptionsMap() map[string]any {
...
func (sdk *MultifonClientSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MultifonClientSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MultifonClientSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MultifonClientSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MultifonClientSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MultifonClientSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MultifonClientSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MultifonClientSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MultifonClientSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MultifonClientSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MultifonClientSDK {
	...
	sdk := NewMultifonClientSDK(sdkopts)
	sdk.Mode = "test"
