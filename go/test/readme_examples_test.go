...
const testSeed = `map[string]any{"entity": map[string]any{"account_management": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
