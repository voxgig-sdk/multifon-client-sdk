...
type AccountManagementEntity struct {
	name    string
	client  *core.MultifonClientSDK
...
func NewAccountManagementEntity(client *core.MultifonClientSDK, entopts map[string]any) *AccountManagementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AccountManagementEntity) GetName() string { return e.name }
...
func (e *AccountManagementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AccountManagementEntity) Deleted() bool {
	return e.deleted
}


func (e *AccountManagementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAccountManagementEntity(e.client, opts)
}

func (e *AccountManagementEntity) Data(args ...any) any {
...
func (e *AccountManagementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AccountManagement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AccountManagementEntity) DataTyped(data ...AccountManagement) AccountManagement {
	if len(data) > 0 {
		return typedFrom[AccountManagement](e.Data(asMap(data[0])))
	}
	return typedFrom[AccountManagement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AccountManagement (all fields
// optional at the wire level).
func (e *AccountManagementEntity) MatchTyped(match ...AccountManagement) AccountManagement {
	if len(match) > 0 {
		return typedFrom[AccountManagement](e.Match(asMap(match[0])))
	}
	return typedFrom[AccountManagement](e.Match())
}
...
func (e *AccountManagementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AccountManagementEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AccountManagementLoadMatch and returns an AccountManagement. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AccountManagementEntity) LoadTyped(reqmatch AccountManagementLoadMatch, ctrl map[string]any) (AccountManagement, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AccountManagement{}, err
	}
	return typedFrom[AccountManagement](res), nil
}



func (e *AccountManagementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AccountManagementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AccountManagementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AccountManagementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AccountManagementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
